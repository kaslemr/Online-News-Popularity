...
Finally, we'll evaluate the performance of each model by the root mean squared error of its predictions on the test dataset, which was left of out training the model. This should be a good approximation of the model's performance on unseen data.
